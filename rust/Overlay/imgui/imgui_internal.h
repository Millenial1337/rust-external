...
namespace ImGui
{
	...
	IMGUI_API bool			SliderBehavior2(const ImRect& frame_bb, ImGuiID id, const char* display_format, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags);
